...
*Emergence* is a rudimentary visualiser/processor of a primordial particle system and its emergent/interactive properties.
...
- For example, let us say you cloned this repository in the Downloads folder. You would open a browser tab and visit =file:///home/user/Downloads/mff/emergence/index.html=.
