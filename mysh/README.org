...
- code structure ::
  ...
  - *(mysh/)sample.mysh* - a sample non-interactive script, try with =./mysh sample.mysh=
...
- phase 1 post hoc ::
  - :-D handle ^C to kill foreground process
  - :-D return value of signalled command is 128
