...
- code structure ::
  - outline
    ...
    2. "mode" of the shell is determined: [[https://github.com/agarick/mff/blob/master/mysh/src/main.c#L14][main()]], [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L91][opt()]], [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L278][loop()]]
    3. repl starts: [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L278][loop()]], [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L205][loop_body()]]
    4. input is read, variation depending on mode: [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L278][loop()]], [[https://github.com/agarick/mff/blob/master/mysh/src/repl.c#L120][get()]]
    5. read input is parsed into tokens: [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L310][parse()]]
    6. tokens are evaluated: [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L475][eval()]]
    7. commands are spawned: [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L346][spawn()]]
  ...
  - data
    ...
    - the populating of semis, cmds, and words are done through [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L327][nested string splitting]].
  - redirecting
    - [[https://github.com/agarick/mff/blob/master/mysh/src/util.c#L64][chop off]] any trailing substrings that [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L583][look redirectible]], and [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L166][behave accordingly]].
  - piping
    - each spawn is [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L351][given parameters]] describing [[https://github.com/agarick/mff/blob/master/mysh/src/parse.c#L550][its place in]] the pipeline.
  - files
    - *makefile* - for =make ...=
...
- phase 2 more ::
  ...
  - :-D various issues (see github [[https://github.com/agarick/mff/issues/13][#13]], [[https://github.com/agarick/mff/issues/14][#14]], [[https://github.com/agarick/mff/issues/15][#15]], [[https://github.com/agarick/mff/issues/16][#16]], [[https://github.com/agarick/mff/issues/17][#17]], [[https://github.com/agarick/mff/issues/18][#18]], [[https://github.com/agarick/mff/issues/19][#19]])
